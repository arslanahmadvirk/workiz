...
const reviews = [
  {
    ...
    body: 'Fast and easy to use I scheduled a last minute lawn mowing and was able to get it done the next day. The lawn looks greatHelen',
    author: 'CrazyInvestor',
    rating: 5,
  },
  {
    title: 'You need this app.',
    body: 'convenient and affordable what a great service. I love that I can schedule lawn care on the go. I highly recommend landscape',
    author: 'CluelessButRich',
    rating: 5,
  },
  {
    title: 'Better than expected',
    body: 'Better than expected I was skeptical at first, but the lawn looks great and the price was very reasonable.',
  ...
  },
  {
    ...
    body: 'No more calling around to find a lawn care professional. Landscape makes it so easy.',
    author: 'JeffBezos',
    rating: 5,
  },
]
  ...
  return (
    ...
    >
      <Container>
        ...
        >
          Everyone is changing their life with Landscape.
        </h2>
